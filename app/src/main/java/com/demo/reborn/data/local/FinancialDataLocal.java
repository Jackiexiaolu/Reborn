package com.demo.reborn.data.local;
...
public class FinancialDataLocal implements FinancialDataInterface {
    @Override
    public  Observable<Response<Api1_FirmgraphHolders_single>> get_Api1_FirmgraphHolders_single(String c_id){return null;}

    @Override
    public Observable<Response<Api1_FinancingIndex>> get_Api1_FinancingIndex(String c_id){return null;}
    ...
    @Override
    public Observable<Response<Api1_post_common>> post_Delete_Trust(String uuid){return null;}

    @Override
    public Observable<Response<Api1_Dic_Filling>> get_Dic_Filling(){return null;}

    @Override
    public  Observable<Response<Api1_Dic_Filling>> get_Main_Term_Type(){return null;}

    @Override
    public Observable<Response<Api1_Dic_Filling>> get_Asset_Plan_Type(){return null;}

    @Override
    public Observable<Response<Api1_Opportunity_Abstract>> get_Opportunity_Abstract(String c_id, String first_level_name){return null;}

    @Override
    public Observable<Response<Api1_Business_Opportunity>> get_Business_Opportunity(String c_id, String first_level_name){return null;}
    ...
    @Override
    public Observable<Response<Api1_post_common>> post_Modify_Code(String mobile,String img_code){return null; }

    @Override
    public Observable<Response<Api1_post_common>> post_Search_Behavior(String first_event_id, String keyword, String time){return null;}

    @Override
    public Observable<Response<Api1_post_common>> post_Click_Search(String first_event_id, String c_id, String time){return null;}
    ...
    public Observable<Response<Api1_post_common>> post_Browse_Recode(String first_event_id,String second_event_id, String third_event_id,
                                                                     String c_id,String start_time,String end_time){return null;}

    @Override
    public  Observable<Response<Api1_post_common>> post_Cancel_Login(String phoneNumber,String graphCheckCode){return null;}
}
